...
async function fetchPage({canonicalURL, requestURL, requestOptions, headers}) {
  ...
  async function fetchURL({ canonicalURL, headers }) {
    ...
    fetchURL({canonicalURL:`https://www.csj.gov.py/ResolucionesWeb/Formularios/inicio.aspx?from=10-04-2023&to=20-04-2023&Circunscripción=central&tipoDeResolucion=autoInterlocutorio&page=1&pg=new`}).catch((err) => {console.log(err)}).then((res) => {console.log(res)})
