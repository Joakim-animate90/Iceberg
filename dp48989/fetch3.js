...
const getHome = async function ({argument, canonicalURL, headers}) {
        ...
        let requestURL = 'https://justice.public.lu/fr/jurisprudence/cour-cassation.html';
...
const  getPagination = async function ({argument, canonicalURL, headers}) {
    ...
    let page = match[1];
        let customHeaders = {
                    "Cache-Control": "no-cache",
                    "Pragma": "no-cache",
                    "Referer": "https://justice.public.lu/fr/jurisprudence/cour-cassation.html",
                    "Sec-Fetch-Dest": "document",
                    "Sec-Fetch-Mode": "navigate",
        ...
        let method = "GET";
        let requestOptions = {method, headers: _headers};
        let requestURL = `https://justice.public.lu/fr/jurisprudence/cour-cassation.html?b=${page}`;
        let responsePage = await fetchPage({canonicalURL, requestURL, requestOptions});
        return responsePage;
    };
